...
Lustre działa na różnych jądrach Linuksa z dystrybucji Linuksa, w tym RHEL, CentOS i SLES. Używając tylko Lustre LDISKFS OSD, konieczne będzie poprawienie jądra przed zbudowaniem Lustre. Lustre ZFS OSD i kod klienta nie wymagają poprawek do jądra.
