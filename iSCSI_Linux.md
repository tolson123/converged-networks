...
```
cd /iscsi
create iqn.2017-11.converged.srv:storage.target01
```

###### Ustawienie LUN
```
cd iqn.2017-11.converged.srv:storage.target01/tpg1/luns
...
```
cd ../acls
create iqn.2017-11.converged.srv:www.srv.converged
```
...
InitiatorName=iqn.2017-11.converged.srv:www.srv.converged
```
